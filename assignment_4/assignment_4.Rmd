...
dataset2 <- dataset %>%
    ...
    mutate(exit_rate_male = fail_male / n_male, survivor_func_male = 1-exit_rate_male,
           exit_rate_female = fail_female / n_female, survivor_func_female = 1-exit_rate_female,
           exit_rate_fixed = fail_fixed / n_fixed, survivor_func_fixed = 1-exit_rate_fixed,
           exit_rate_temp = fail_temp / n_temp, survivor_func_temp = 1-exit_rate_temp)
