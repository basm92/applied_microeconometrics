...
paste("The lower bound for $E[Y^*_1 - Y^*_0]$ is", expected_y_given_deq1 * pr_treated + pr_untreated * y_min
      - expected_y_given_deq0 * pr_untreated - pr_treated*y_max)
paste("The upper bound for $E[Y^*_1 - Y^*_0]$ is", 0)
