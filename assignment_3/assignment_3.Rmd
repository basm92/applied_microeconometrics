...
library(kableExtra); library(MatchIt); library(plm)
...
stargazer(models, omit.stat = c("ll", "ser", "rsq"), df=F, 
          ...
          header = FALSE, font.size = "footnotesize", title='Estimated model for Q2.')
...
stargazer(e_0i, e_1i, ate, header = F, 
          ...
          effect on the treated on the change in employments in the restaurants.')
...
We first calculate the nearest neighbour weighting estimate, using the `matched_data3` data.frame, which implements nearest-neighbor matching:
